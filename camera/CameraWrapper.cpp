...
static char *camera_get_parameters(struct camera_device *device)
{
    ...
    if (CAMERA_ID(device) == BACK_CAMERA_ID) {
        ...
        params.set(CameraParameters::KEY_SUPPORTED_VIDEO_SIZES,
            "3840x2160,1920x1080,1280x720,864x480,800x480,720x480,640x480,320x240,176x144");
        ...
        params.set("supported-live-snapshot-sizes",
            "4000x3000,3200x2400,2592x1944,2560x1440,2048x1536,1920x1440,1920x1080,1600x1200,1280x768,1280x720,1024x768,800x600,864x480,800x480,720x480,640x480,320x240,176x144");
