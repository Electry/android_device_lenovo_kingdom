...
#define NXPTFA_APP_REV_MINOR    (3)         // minor
...
//#define TFA_I2CDEVICE        "/dev/i2c-7"        // Panda = 4 device driver interface special file
...
Tfa98xx_Error_t tfa98xxSetEqualizerStereo(Tfa98xx_handle_t *handlesIn, const char* eqData);
